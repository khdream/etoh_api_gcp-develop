...
from productspec.models import (Aroma, Assemble, CategoryLexicon, Lexicon, Robe, Vintage,
                                WineCDCLexicon, WineProfileCDC)
from productspec.serializers import (AromaSerializer,
                                     AssembleSerializer,
                                     CategoryLexiconSerializer,
                                     LexiconSerializer, RobeSerializer,
                                     VintageSerializer,
                                     WineCDCLexiconSerializer,
                                     WineProfileCDCSerializer,
...
class AssembleViewSet(ModelViewSet):
...
class RobeViewSet(ModelViewSet):
    serializer_class = RobeSerializer
...
class WineProfileCDCViewSet(ModelViewSet):
    serializer_class = WineProfileCDCSerializer
    queryset = WineProfileCDC.objects.all()
...
class VintageViewSet(ModelViewSet):
...
class CategoryLexiconViewSet(ModelViewSet):
    serializer_class = CategoryLexiconSerializer
    queryset = CategoryLexicon.objects.all()
...
class LexiconViewSet(ModelViewSet):
...
class WineCDCLexiconViewSet(ModelViewSet):
    serializer_class = WineCDCLexiconSerializer
    queryset = WineCDCLexicon.objects.all()
